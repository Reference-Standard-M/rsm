...
The snap installs with three commands: `rsm` for direct mode, `rsm.man` for the
...
NOTE: The database file is managed automatically by the snap at
`$SNAP_COMMON/rsm.dat`.
...
NOTE: Removing the snap does not delete the database file at
